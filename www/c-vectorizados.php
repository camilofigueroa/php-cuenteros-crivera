<?php
    ...
    $lista_capitulos = Vimprimir::organizar( Consultas::traer_capitulo_objetos( $_SESSION[ 'id_proyecto' ], null, 1 ), "1", null, 1, "lista_capitulos", "onchange='al_cambiar_listar( this, 1 )'" );
    $lista_vectorizados = Vimprimir::organizar( Consultas::traer_vectorizados( $_SESSION[ 'id_proyecto' ] ), "1", null, 1, "lista_vectorizados" );
